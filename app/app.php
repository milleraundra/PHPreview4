...
//view store page
    $app->get("/store/{id}", function($id) use ($app) {
        $store = Store::find($id);
        $message = null;
        return $app['twig']->render('store.html.twig', array('store' => $store, 'all_stores' => Store::getAllExcept($id), 'match_brands' => $store->getBrands(), 'all_brands' => $store->getNonmatchBrands(), 'message' => $message));
    });
